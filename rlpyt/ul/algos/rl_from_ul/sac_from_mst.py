...
OptInfo = namedtuple("OptInfo", ["q1Loss", "q2Loss", "piLoss", "qGradNorm", "piGradNorm",
...
class SacFromMst(RlAlgorithm):
    ...
    def initialize(self, agent, n_itr, batch_spec, mid_batch_reset, examples, world_size=1, rank=0):
        ...
        self.min_itr_learn = self.min_steps_learn // sampler_bs  # calculate the total update itrs
    ...
    def optimize_agent(self, itr, samples=None, sampler_itr=None):
        ...
        if itr < self.min_itr_learn:
            return opt_info
        # update/back_propagation times every itr
        # default equal to the num of transition collected by collectors
