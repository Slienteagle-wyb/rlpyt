...
config = dict(
    algo=dict(
        batch_B=48,  # batch_size X time (16, 32)
        batch_T=80,  # batch_T = warm_up(16) + contrast_rollout(16)
    ...
    replay=dict(
            ...
            forward_step=79,  # the forward step for extracting batch, total extracted batch_T = 1 + forward_step
            translation_dim=3,
            rotation_dim=6,
