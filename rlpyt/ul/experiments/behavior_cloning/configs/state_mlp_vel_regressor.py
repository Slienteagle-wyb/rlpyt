...
config = dict(
    algo=dict(
        ...
        # f"/home/yibo/Documents/rlpyt/data/local/20220629/160338/mst_pretrain/mst_0629_run1/params.pkl"
    ...
    runner=dict(
        n_epochs=int(50),
        log_interval_updates=int(500),
        snapshot_gap_intervals=10,  # equal to num of interval
        wandb_log=True,
        wandb_log_name=None,
    ),
    train_replay=dict(
        ...
        frame_stacks=1,
        data_path=f'/home/yibo/spaces/datasets/il_datasets',
        episode_length=4096,
        num_runs=2,
        forward_step=0,
        translation_dim=3,
