...
runs_per_setting = 1
experiment_title = "stc_vel_regressor"
...
dir_names = ['stc_0318_run1']
variant_levles.append(VariantLevel(keys, values, dir_names))

keys = [('algo', 'learning_rate'), ('runner', 'wandb_log_name')]
values = [[5e-4, 'stc_0318_lr_5e-4'], [2.5e-4, 'stc_0318_lr_2.5e-4']]
