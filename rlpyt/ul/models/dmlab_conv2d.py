...
class DmlabConv2dModelBn(torch.nn.Module):
    def __init__(
            self,
            in_channels,
        ...
        self.bn1 = init_normalization(channels=32, type_id=norm_type, one_d=False)
        ...
        self.bn2 = init_normalization(channels=64, type_id=norm_type, one_d=False)
        ...
        self.bn3 = init_normalization(channels=64, type_id=norm_type, one_d=False)
        if use_fourth_layer:
            ...
            self.bn4 = init_normalization(channels=64, type_id=norm_type, one_d=False)
        else:
            self.conv4 = None
        # if skip_connections:
